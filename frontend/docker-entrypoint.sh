...
PUBLIC_ENV_REGEX='^(VITE_FIREBASE_|VITE_GIT_COMMIT=|VITE_APP_REVISION=|VITE_APP_REVISION_BRANCH=|VITE_APP_REVISION_DIRTY=|VITE_APP_REVISION_UPDATED_AT=|VITE_ENABLE_LEGACY_AUTH=|VITE_AFK_TIMEOUT_MS=|FIREBASE_|GIT_COMMIT=|APP_REVISION=|APP_REVISION_BRANCH=|APP_REVISION_DIRTY=|APP_REVISION_UPDATED_AT=)'
